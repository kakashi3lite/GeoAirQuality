...
| [**Design specs**](design/) | [Frontend](design/frontend.md) ✅ implemented (see [wireframe-blueprint](design/wireframe-blueprint.md)) · [UI/UX reference](design/uiux.md) · [Auth](design/auth.md) · [ML Pipeline](design/ml-pipeline.md) — 📋 not yet implemented |
